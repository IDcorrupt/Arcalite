...
if ($num_of_users > 0) {
    ReturnError(409, "HIBA! Már van fiók ilyen felhasználónévvel!");
}
...
if ($num_of_users > 0) {
    ReturnError(409, "HIBA! Már van fiók regisztrálva ehhez az e-mail címhez!");
}
...
if (!$result) {
    ReturnError(500, "HIBA! Hiba az adatok feltöltése közben.");
}
